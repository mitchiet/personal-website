  ...
  return (
    <div ref={ref}>
      ...
      {ReactDOM.createPortal(
        <div>
          <AltiumDialog className="absolute modal flex flex-col rounded-3xl inset-x-0 mx-auto top-26 max-h-[80vh] min-h-50 max-w-5/6 sm:max-w-lg"
              isOpen={isAltiumDialogOpen} isOpenSetter={setIsAltiumDialogOpen} isESP32DialogOpenSetter={setIsESP32DialogOpen} />
          <ESP32Dialog className="absolute modal flex flex-col rounded-3xl inset-x-0 mx-auto top-26 max-h-[80vh] min-h-50 max-w-5/6 sm:max-w-lg"
              isOpen={isESP32DialogOpen} isOpenSetter={setIsESP32DialogOpen} />
          <JavaDialog className="absolute modal flex flex-col rounded-3xl inset-x-0 mx-auto top-26 max-h-[80vh] min-h-50 max-w-5/6 sm:max-w-lg"
              isOpen={isJavaDialogOpen} isOpenSetter={setIsJavaDialogOpen} />
          <LaTeXDialog className="absolute modal flex flex-col rounded-3xl inset-x-0 mx-auto top-26 max-h-[80vh] min-h-50 max-w-5/6 sm:max-w-lg"
              isOpen={isLaTeXDialogOpen} isOpenSetter={setIsLaTeXDialogOpen} />
          <TailwindCSSDialog className="absolute modal flex flex-col rounded-3xl inset-x-0 mx-auto top-26 max-h-[80vh] min-h-50 max-w-5/6 sm:max-w-lg"
